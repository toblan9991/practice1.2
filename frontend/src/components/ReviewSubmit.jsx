...
const DisplayFormData = ({ formData, setFormData }) => {
  const dataToDisplay = useMemo(() => {
    return [
      ...
      { label: "Assign Department", value: formData.department, name: "department" },
      { label: "Employee SIN Number", value: formData.sin, name: "sin" },
      { label: "Manager's Name", value: formData.managerName, name: "managerName" },
      { label: "Manager's Email", value: formData.managerEmail, name: "managerEmail" },
